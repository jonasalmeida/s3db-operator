function [y,x]=migrate(x,n,g)

%MIGRATE migration of assigned permissions in S3DB inheritance
%Syntax: y=migrate(x,n,g)
...
elseif m2==1 %there are just enough digits to define the current state
    ...
    y=[x(n+1:end),[char(ones(1,max([0,((n*m2-m1)-nx+1)]))*x(end))]];
end
